...
class UserPreferencesManager {
    ...
    applySoundSettings() {
        ...
        if (window.soundManager) {
            ...
            if (this.preferences.soundVolume !== undefined) {
                window.soundManager.setVolume(this.preferences.soundVolume / 100);
            }
        }
        
        console.log(`[PREFERENCES] Som configurado: enabled=${this.preferences.soundEnabled}, volume=${this.preferences.soundVolume}`);
    }
