...
class ModernUpdateManager {
    ...
    async checkForUpdates(silent = false) {
        ...
        try {
            ...
            // Usar canal silencioso (com timeout no processo principal) quando for verificação silenciosa
            const channel = silent ? 'check-for-updates-quiet' : 'check-for-updates';
